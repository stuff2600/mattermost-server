...
// GetChannelsWithChannelContextPermission provides a mock function with given fields: channelIds
func (_m *ChannelStore) GetChannelsWithChannelContextPermission(userID string, permissionName string) store.StoreChannel {
